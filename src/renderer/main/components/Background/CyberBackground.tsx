  ...
  return (
    <div className="cyber-background">
      ...
      <div className="cyber-pattern-wrapper pattern-1">
        <img
          src={`${basePath}images/cyber-patterns/pattern-1-v3.png`}
          alt=""
      ...
      <div className="cyber-pattern-wrapper pattern-2">
        <img
          src={`${basePath}images/cyber-patterns/pattern-2-v2.png`}
          alt=""
          className="cyber-pattern-image"
          loading="lazy"
        />
      ...
      <div className="cyber-pattern-wrapper pattern-4">
        <img
          src={`${basePath}images/cyber-patterns/pattern-4.png`}
          alt=""
          className="cyber-pattern-image"
          loading="lazy"
        />
      ...
      <div className="cyber-pattern-wrapper pattern-3">
        <img
          src={`${basePath}images/cyber-patterns/pattern-3-v2.png`}
          alt=""
          className="cyber-pattern-image"
          loading="lazy"
        />
